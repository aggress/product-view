// Product View — Variant B
// 20x20 grid of 10px circles (5px gap) on black. Hovering a circle scales it
// to 20px (2x); the 8 direct neighbours (ring 1) shrink to 50% and the second
// ring (Chebyshev distance 2) shrinks to 75% for a softer falloff.
// All motion is CSS transform + a 200ms ease-out transition.

const COLS = 20;
const ROWS = 20;
const PITCH = 15; // 10px circle + 5px gap
const RADIUS = 2; // cells affected beyond the hovered one
